      ...
      <div class="card-body card-block">
        ...
        <form action="../controller/productController.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9"><input type="text" id="password-input" name="mota" value="<?php echo $product['mota'] ?>" class="form-control"></div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="pic" style="width: 200px; height: 250px; margin-left:20px; border: 1px solid;">
              <img name="hinh" id="hinh" style="min-width: 200px; max-height: 250px;" src="<?php echo "./assets" . $product['hinh'] ?>" alt>
            </div>
