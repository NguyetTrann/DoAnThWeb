          ...
          <div class="w-full">
            ...
            <form action="./controller/loginadminController.php" method="POST">
              <label class="block text-sm">
                ...
                <input name="username" type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
              </label>
              ...
              <button type="submit" name="action" value="login" class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="./index.php">
                Log in
              </button>
            </form>
            <p class="mt-4">
